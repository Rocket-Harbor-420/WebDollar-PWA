...
- El APK debug recompilado tiene SHA-256 `CECD02B854CEDB156FDCB43F1F82598A7F5125C96FE848F566E804364F86C47E`. La compilación y las cuatro pruebas de navegador pasan tras corregir el transporte binario, la revisión del envío, el seguimiento automático de confirmación, el motor de minería y la actualización inmediata del Service Worker; la recompilación actual incluye i18n, NFC con fallback QR y elimina el recurso independiente de Argon2 que no tenía referencias.
- El build local también produce `build/release/WebDollar-wallet-debug.aab`, SHA-256 `467F071ED9F429E0EEDAFB3C00E6B33280CD0175E949043AA3138322CC38588E`.

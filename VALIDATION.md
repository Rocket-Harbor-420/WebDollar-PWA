...
- El APK debug recompilado tiene SHA-256 `A9F78FC6602628E1F415B02C783C61F46C30D65120D19CD410C40A787FDF92D7`. La compilación y las cuatro pruebas de navegador pasan tras corregir el transporte binario, la revisión del envío, el seguimiento automático de confirmación, el motor de minería y la actualización inmediata del Service Worker; la recompilación actual también elimina el recurso independiente de Argon2 que no tenía referencias.

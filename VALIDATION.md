...
- El APK debug v3.0 recompilado tiene SHA-256 `AE0516B547C358AC3232ED40F3043D00495FACAC7442DE05BA0C8165AE47E254`. La compilación y las seis pruebas de navegador pasan; la recompilación incluye cinco idiomas, tema persistente, AES-GCM, mensajería, métricas de minería, NFC con fallback QR, protección de vales offline v2 y el adaptador Marketplace Mainnet con capability gate.
- El build local también produce `build/release/WebDollar-wallet-debug.aab`, SHA-256 `1C76EA0440B381549CF769EF6E3E83BD74ED280F5F225CAFC2760183BA8A7F6D`.
- La suite de protocolo contiene 20 pruebas, incluyendo roundtrip AES-GCM y rechazo de replay por nonce/voucher. `npm run probe:mining` volvió a completar el handshake Mainnet de solo lectura con trabajo PoS real, sin acceder a claves privadas ni transmitir transacciones.

const CACHE_NAME='webdollar-wallet-v14';
const APP_SHELL=['./','./index.html','./styles.css','./manifest.json','./assets/icon-192.png','./assets/icon-512.png','./src/app.js','./src/core/constants.js','./src/core/crypto.js','./src/core/ed25519.js','./src/core/event-bus.js','./src/core/native-socket.js','./src/core/network.js','./src/core/plugin-manager.js','./src/core/qr.js','./src/core/transaction.js','./src/core/wallet.js','./src/core/webd-format.js','./src/vendor/dependencies.js','./src/vendor/argon2-bundled.min.js','./src/modules/mining.js','./src/modules/offline.js','./src/workers/mining-pow-worker.js'];

...
const required=['index.html','styles.css','manifest.json','service-worker.js','src/app.js','src/core/wallet.js','src/core/transaction.js','src/core/network.js','src/core/webd-format.js','src/core/plugin-manager.js','src/core/i18n.js','src/locales/es.json','src/locales/en.json','src/core/interfaces.d.ts','src/modules/mining.js','src/modules/offline.js','architecture.mermaid','API_CORE.md','USER_MANUAL.md','README.md','PROPOSALS.md','build-apk.js','android/settings.gradle','android/build.gradle','android/app/build.gradle','android/app/src/main/AndroidManifest.xml','android/app/src/main/java/com/webdollar/wallet/MainActivity.java'];

...
| Marketplace | Adaptador Mainnet real: consulta Assets nativos WebDollar2 o `/address/assets`; firma/transmite listados solo cuando el nodo anuncia `webdollar-marketplace-v1` |
